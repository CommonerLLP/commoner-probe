...
| `mp_code` | integer\|null | cond | Stable member code echoed by the API row; stamped on member-ID retrieval | sansad.py |
...
**Note — LS member-ID variant (`--mp-code`)**: LS records retrieved
