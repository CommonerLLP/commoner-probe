...
from .verbatim_pdf_api import date_to_iso
...
class QuestionsListProbe:
    ...
    def __init__(
        ...
        *,
        ...
        # The corpus filename and the extractor id below keep their original
        # spelling on purpose. They are DATA: corpora already on disk carry
        # them, and a module rename is not a change to what was extracted.
